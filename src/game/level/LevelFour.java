...
public class LevelFour implements Level {
    ...
    public void init(WorldContext worldContext) {
        ...
        worldContext.addEntity(EntityCategory.ENEMY, new EnemyBasic(Game.getRandomX(), Game.getRandomY(), Game.random(-3, 3), Game.random(-3, 3), 15, worldContext));
        worldContext.addEntity(EntityCategory.ENEMY, new EnemyBasic(Game.getRandomX(), Game.getRandomY(), Game.random(-4, 4), Game.random(-4, 4), 18, worldContext));
        ...
        worldContext.addEntity(EntityCategory.ENEMY, new EnemyUnpredictable(Game.getRandomX(), Game.getRandomY(), Game.random(-3, 3), Game.random(-4, 4), 14, worldContext));
